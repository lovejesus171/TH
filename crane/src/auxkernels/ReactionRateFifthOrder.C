...
#include "ReactionRateFifthOrder.h"

registerMooseObject("CraneApp", ReactionRateFifthOrder);

template <>
InputParameters
validParams<ReactionRateFifthOrder>()
{
  ...
  params.addCoupledVar("y", "The fourth reactant.");
  params.addCoupledVar("z", "The fifth reactant.");
...
ReactionRateFifthOrder::ReactionRateFifthOrder(const InputParameters & parameters)
...
Real
ReactionRateFifthOrder::computeValue()
{

  return 6.02e23 * _reaction_coeff[_qp] * _v[_qp] * _w[_qp] * _x[_qp] * _y[_qp] * _z[_qp];
}

...
#include "ReactionRateFourthOrder.h"

registerMooseObject("CraneApp", ReactionRateFourthOrder);

template <>
InputParameters
validParams<ReactionRateFourthOrder>()
{
...
ReactionRateFourthOrder::ReactionRateFourthOrder(const InputParameters & parameters)
...
Real
ReactionRateFourthOrder::computeValue()
{

  return 6.02e23 * _reaction_coeff[_qp] * _v[_qp] * _w[_qp] * _x[_qp] * _y[_qp];
}

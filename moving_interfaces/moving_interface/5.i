...
[UserObjects]
  [./velocity]
    ...
    diffusivity_at_positive_level_set = 3600e-12
    diffusivity_at_negative_level_set = 3600e-10
...
[Materials]
  [./diffusivity_A]
    ...
    prop_values = 3600e-12
  [../]
  [./diffusivity_B]
    type = GenericConstantMaterial
    prop_names = B_diffusion_coefficient
    prop_values = 3600e-10
  [../]
  [./diff_combined]

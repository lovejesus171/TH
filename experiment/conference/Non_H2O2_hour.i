...
# Diffusion terms
  ...
  [./DgradH2O]
    block = 'Solution'
    type = CoefDiffusion
    coef = 8.32e-6 #[m2/s], at 25C
    variable = H2O
  [../]
  [./DgradHp]
    block = 'Solution'
    type = CoefDiffusion
    coef = 3.63e-5 #[m2/s], at 25C
    variable = H+
  [../]
  [./DgradOHm]
    block = 'Solution'
    type = CoefDiffusion
    coef = 1.74e-5 #[m2/s], at 25C
    variable = OH-
  [../]
  [./DgradH2O2]
    block = 'Solution'
    type = CoefDiffusion
    coef = 1.74e-5 #[m2/s], to be added
    variable = H2O2
  [../]
  [./DgradSO42m]
    block = 'Solution'
...
[ChemicalReactions]
 [./Network]
   ...
   reactions = 'H2O -> OH- + H+ : {0.09*exp(-45.4e3/R*(1/T_Re-1/T))}
                OH- + H+ -> H2O : {5.04e14*exp(-12.6e3/R*(1/T_Re-1/T))}
                HS- + H2O2 + H2O2 + H2O2 + H2O2 -> OH- + H+ + H+ + SO42- : {1.98*exp(-51e3/R*(1/T_Re-1/T))}
                HS- + O2 -> SO42- + H+ : {1.3e14*10^(11.78-3000/T)}'
[../]
[]

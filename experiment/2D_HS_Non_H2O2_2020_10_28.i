...
[ChemicalReactions]
 [./Network]
   ...
   reactions = 'H2O -> OH- + H+ : {2.5e-5*exp(-45.4e3/(R*T))}
                OH- + H+ -> H2O : {1.4e8*exp(-12.6e3/(R*T))}
                HS- + H2O2 + H2O2 + H2O2 + H2O2 -> OH- + H+ + H+ + SO42- : {5.5e-4*exp(-51e3*(1/298.15-1/T)/R)}

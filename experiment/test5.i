...
[ReactionNetwork]
  ...
  [./SolidKineticReactions]
    primary_species = 'ca2+ hco3- h+ so3 so4'
    kin_reactions = 'ca2+ + hco3- - h+ = caco3_s,
                     ca2+  = so4
                   '
    secondary_species = caco3_s
    log10_keq = '1.8487 1'
    reference_temperature = '298.15 298.15'
    system_temperature = 298.15
    gas_constant = 8.314
    specific_reactive_surface_area = '4.61e-4 1'
    kinetic_rate_constant = '6.456542e-7 1e-10'
    activation_energy = '1.5e4 1.5e4'
  [../]
[]

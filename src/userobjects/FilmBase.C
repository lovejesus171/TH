...
FilmBase::FilmBase(const InputParameters & parameters)
...
//  if (isElementActivated() && _current_elem->subdomain_id() != _inactive_subdomain_id)
  {
    /*
...
void
FilmBase::getNodesToRemoveFromBnd(std::set<dof_id_type> & remove_set,
...
void
FilmBase::insertNodeIdsOnSide(const Elem * ele,
...
void
FilmBase::updateBoundaryInfo(MooseMesh & mesh)
{
...
void
FilmBase::push_boundary_side_info(
    MooseMesh & mesh,
    std::unordered_map<processor_id_type, std::vector<std::pair<dof_id_type, unsigned int>>> &
        elems_to_push)
{
...
void
FilmBase::push_boundary_node_info(
    MooseMesh & mesh,
...
ConstElemRange *
FilmBase::getNewlyActivatedElementRange()
{
...
ConstBndNodeRange *
FilmBase::getNewlyActivatedBndNodeRange()
{
  // deletes the object first
...
ConstNodeRange *
FilmBase::getNewlyActivatedNodeRange()
{
  // deletes the object first
...
bool
FilmBase::isNewlyActivated(const Node * nd)
{
...
void
FilmBase::initSolutions(ConstElemRange & elem_range,

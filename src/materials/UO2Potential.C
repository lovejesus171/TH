...
#include "UO2Potential.h"

registerMooseObject("corrosionApp", UO2Potential);

InputParameters
UO2Potential::validParams()
{
...
UO2Potential::UO2Potential(const InputParameters & parameters)
  : Material(parameters),
    _T(coupledValue("T")),
    _C1(coupledValue("C1")),
    _C2(coupledValue("C2")),
...
void
UO2Potential::initQpStatefulProperties()
{
}

void
UO2Potential::computeQpProperties()
{
  Real F = 96485;
  Real R = 8.314;
  Real Tref = 298.15;

...
#include "InterfaceEcorr.h"

registerMooseObject("corrosionApp", InterfaceEcorr);

InputParameters
InterfaceEcorr::validParams()
{
...
InterfaceEcorr::InterfaceEcorr(const InputParameters & parameters)
  : InterfaceMaterial(parameters),
    ...
    _SulfideAnodeArea(declareProperty<Real>("SulfideAnodeArea")),
    _ChlorideAnodeArea(declareProperty<Real>("ChlorideAnodeArea"))
{
}

void
InterfaceEcorr::initQpStatefulProperties()
{
  _ISS[_qp] = 0;
  _IEE[_qp] = 0;
  _Isum[_qp] = 0;
...
void
InterfaceEcorr::computeQpProperties()
{
  Real F = 96485;
  Real R = 8.314;

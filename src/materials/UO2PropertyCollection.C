...
#include "UO2PropertyCollection.h"

registerMooseObject("corrosionApp", UO2PropertyCollection);

InputParameters
UO2PropertyCollection::validParams()
{
...
UO2PropertyCollection::UO2PropertyCollection(const InputParameters & parameters)
  : Material(parameters),
...
void
UO2PropertyCollection::initQpStatefulProperties()
{
...
void
UO2PropertyCollection::computeQpProperties()
{
  _Sat_UO22p[_qp] = _UO22pValue;
  _Sat_UO2CO322m[_qp] = _UO2CO322mValue;
  _Sat_UOH4[_qp] = _UOH4Value;

...
#include "UO2PropertyCollectionYearBack.h"

registerMooseObject("corrosionApp", UO2PropertyCollectionYearBack);

InputParameters
UO2PropertyCollectionYearBack::validParams()
{
...
params.addParam<Real>("kMB_value", 1.43E-8, "Constant");
  params.addParam<Real>("kNB_value", 7.46E-1, "Constant");
  params.addParam<Real>("kOB_value", 1.8E-26, "Constant");
  params.addParam<Real>("kPB_value", 9.4E-19, "Constant");
  params.addParam<Real>("kQB_value", 6E-2, "Constant");
  params.addParam<Real>("kRB_value", 1.15E-9, "Constant");
  params.addParam<Real>("kSB_value", 4.77E16, "Constant");
  params.addParam<Real>("kTB_value", 9.15E8, "Constant");
  params.addParam<Real>("kUB_value", 5.82E89, "Constant");
  params.addParam<Real>("kVB_value", 2.98E145, "Constant");
  params.addParam<Real>("kWB_value", 1.47E71, "Constant");
  params.addParam<Real>("kXB_value", 1.85E53, "Constant");
  params.addParam<Real>("kYB_value", 5.34E11, "Constant");


  return params;
}

UO2PropertyCollectionYearBack::UO2PropertyCollectionYearBack(const InputParameters & parameters)
  : Material(parameters),
    ...
    _kMB_value(getParam<Real>("kMB_value")),
    _kMB(declareProperty<Real>("kMB")),
    _kNB_value(getParam<Real>("kNB_value")),
    _kNB(declareProperty<Real>("kNB")),
    _kOB_value(getParam<Real>("kOB_value")),
    _kOB(declareProperty<Real>("kOB")),
    _kPB_value(getParam<Real>("kPB_value")),
    _kPB(declareProperty<Real>("kPB")),
    _kQB_value(getParam<Real>("kQB_value")),
    _kQB(declareProperty<Real>("kQB")),
    _kRB_value(getParam<Real>("kRB_value")),
    _kRB(declareProperty<Real>("kRB")),
    _kSB_value(getParam<Real>("kSB_value")),
    _kSB(declareProperty<Real>("kSB")),
    _kTB_value(getParam<Real>("kTB_value")),
    _kTB(declareProperty<Real>("kTB")),
    _kUB_value(getParam<Real>("kUB_value")),
    _kUB(declareProperty<Real>("kUB")),
    _kVB_value(getParam<Real>("kVB_value")),
    _kVB(declareProperty<Real>("kVB")),
    _kWB_value(getParam<Real>("kWB_value")),
    _kWB(declareProperty<Real>("kWB")),
    _kXB_value(getParam<Real>("kXB_value")),
    _kXB(declareProperty<Real>("kXB")),
    _kYB_value(getParam<Real>("kYB_value")),
    _kYB(declareProperty<Real>("kYB"))

{
}

void
UO2PropertyCollectionYearBack::initQpStatefulProperties()
{
	...
	_kMB[_qp] = _kMB_value * time_changer;
	_kNB[_qp] = _kNB_value * time_changer;
	_kOB[_qp] = _kOB_value * time_changer;
	_kPB[_qp] = _kPB_value * time_changer;
	_kQB[_qp] = _kQB_value * time_changer;
	_kRB[_qp] = _kRB_value * time_changer;
	_kSB[_qp] = _kSB_value * time_changer;
	_kTB[_qp] = _kTB_value * time_changer;
	_kUB[_qp] = _kUB_value * time_changer;
	_kVB[_qp] = _kVB_value * time_changer;
	_kWB[_qp] = _kWB_value * time_changer;
	_kXB[_qp] = _kXB_value * time_changer;
	_kYB[_qp] = _kYB_value * time_changer;

}

void
UO2PropertyCollectionYearBack::computeQpProperties()
{

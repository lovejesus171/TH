...
#include "UO2Potential2.h"

registerMooseObject("corrosionApp", UO2Potential2);

InputParameters
UO2Potential2::validParams()
{
...
UO2Potential2::UO2Potential2(const InputParameters & parameters)
  : Material(parameters),
    _T(coupledValue("T")),
    _C1(coupledValue("C1")),
    _C2(coupledValue("C2")),
...
void
UO2Potential2::initQpStatefulProperties()
{
  Real F = 96485;
  Real R = 8.314;
  Real Tref = 298.15;
...
void
UO2Potential2::computeQpProperties()
{
  Real F = 96485;
  Real R = 8.314;
  Real Tref = 298.15;

...
registerMooseObject("corrosionApp", Por);
...
Por::Por(const InputParameters & parameters)
...
//  Real n = _nO + _nD + _nE + _nF / (_nA * _nS);
  ...
  if (_C1[_qp] <= 1E-15 && _C6[_qp] > 1E-15)
    return E / Alpha + 8.314 * 298.15 / (96485 * Alpha) * log(_nE * _kE * _nF * _kF * (1 - _Porosity)  * (1 - _Porosity)/ (_nA * _kA * _Porosity * _C6[_qp] * _C6[_qp] * _nS * _kS * _C9[_qp]));
  else if (_C6[_qp] <= 1E-15)
    return (E - _EA) / Alpha + 8.314 * 298.15 / (96485 * Alpha) * log(_nE * _kE * _nF * _kF * (1 - _Porosity)  * (1 - _Porosity)/ ( _Porosity * _nS * _kS * _C9[_qp]));
  else
    return E / Alpha + 8.314 * 298.15 / (96485 * Alpha) * log(_kBB * _C1[_qp] * _nE * _kE * _nF * _kF * (1 - _Porosity)  * (1 - _Porosity)/ (_nA * _kA * _Porosity * _C6[_qp] * _C6[_qp] * _nS * _kS * _C9[_qp]));

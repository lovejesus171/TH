...
#include "UO2CO322m_BC_rem.h"
#include "MooseVariable.h"
#include <algorithm>
#include <limits>

registerMooseObject("corrosionApp", UO2CO322m_BC_rem);

defineLegacyParams(UO2CO322m_BC_rem);

InputParameters
UO2CO322m_BC_rem::validParams()
{
...
UO2CO322m_BC_rem::UO2CO322m_BC_rem(const InputParameters & parameters)
...
Real
UO2CO322m_BC_rem::computeQpResidual()
{
	Real Tref = 298.15;
	Real F = 96485;
	Real R = 8.314;
...
Real
UO2CO322m_BC_rem::computeQpJacobian()
{
	Real Tref = 298.15;
	Real F = 96485;
	Real R = 8.314;
...
Real
UO2CO322m_BC_rem::computeQpOffDiagJacobian(unsigned int jvar)
{
	Real Tref = 298.15;
	Real F = 96485;
	Real R = 8.314;

...
registerMooseObject("corrosionApp", ADCuCl2m2);

defineLegacyParams(ADCuCl2m2);

InputParameters
ADCuCl2m2::validParams()
{
...
ADCuCl2m2::ADCuCl2m2(const InputParameters & parameters)

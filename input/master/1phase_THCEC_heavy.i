...
#    Area = 
  [../]
  [./BC_HS-_mixed_canister_side]
    type = ADES2
    variable = HS-
    boundary = spent_fuel_side
    Faraday_constant = 96485
    Kinetic = 216 # m4mol/hr at 25
    AlphaS = 0.5
    Corrosion_potential = Ecorr
...
#    Area = 
  ...
  [./BC_Cl-_mixed_canister_top]
    ...
    kF = 1.188E-4
    kB = 2.4444E-3
    Standard_potential = -0.105
    Num = -2
#    Area = 
  [../]
  [./BC_Cl-_mixed_canister_side]
    type = ADClm
    variable = Cl-
    Reactant1 = CuCl2-
    boundary = spent_fuel_side
...
#    Area = 
  ...
  [./BC_CuCl2-_mixed_canister_top]
    ...
    kB = 2.4444E-3
    Temperature = T
    Standard_potential1 = -0.105
    Num = 1
#    Area = 
  [../]
  [./BC_CuCl2-_mixed_canister_side]
    type = ADCuCl2m
    variable = CuCl2-
    Reactant1 = Cl-
    boundary = spent_fuel
...
#    Area = 
  [../]
  [./BC_CuCl2-_mixed_canister_bottom]
    type = ADCuCl2m
    variable = CuCl2-
    Reactant1 = Cl-
    boundary = spent_fuel_bottom

...
# Chemical spcies
  ...
  [./Diff_Fe2+]
    type = AqPhaseDiffusion
    variable = Fe2+
    D_aq = RD_Fe2_aq # m2/yr
    EA_aq = REA_Fe2_aq # m2/yr
  [../]
  ...
  [./Diff_SO4_2-]
    type = AqPhaseDiffusion
    variable = SO4_2-
    D_aq = RD_SO4_2_aq # m2/yr
    EA_aq = REA_SO4_2_aq # m2/yr
  [../]
  ...
  [./Diff_Cu2+]
    type = AqPhaseDiffusion
    variable = Cu2+
    D_aq = RD_Cu2_aq # m2/yr
    EA_aq = REA_Cu2_aq # J/mol
  [../]
  ...
  [./Diff_CuCl2-]
    type = AqPhaseDiffusion
    variable = CuCl2-
    D_aq = RD_CuCl2_aq # m2/yr
    EA_aq = REA_CuCl2_aq # J/mol
  [../]
  ...
  [./Diff_H2S]
    ...
    variable = H2S
    D_gas = RD_H2S_gas # m2/yr
    EA_gas = RED_H2S_gas # J/mol
  [../]

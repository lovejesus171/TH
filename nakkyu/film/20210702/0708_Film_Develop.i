...
# Diffusion terms
  [./DgradHSF]
    block = 'Film'
    type = CoefDiffusion
    coef = 1e-3 #[m2/hr], from SKI report and I assumed Cu+ ion diffusion coef = HS- diffusion coefficient in Cu2S
    variable = HS-
  [../]
  [./DgradHSS]
    block = 'Solution'
    type = CoefDiffusion
    coef = 1e-3 #[m2/hr], from hand book, original: 1.731E-5 [cm2/s]
    variable = HS-
  [../]
  [./DgradCl-]
    block = 'Film Solution'
    type = CoefDiffusion
    coef = 1E-3 #[m2/hr], from the handbook original: 2.032E-5 cm2/s
    variable = Cl-
  [../]
  [./DgradCuCl2-_SC]
    block = 'Solution'

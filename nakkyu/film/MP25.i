...
[ChemicalReactions]
  [./Network]
    block = 'Film'
    species = 'Cl- HS- Cu2S CuCl2-'
    track_rates = False
    
    equation_constants = 'EA F R T_Re Porosity kF kB kS aS ES12 ES3 aS3'
    equation_values = '-0.105 96485 8.314 298.15 0.2 1.188E-4 2.4444E-3 216 0.5 -0.747 -0.747 0.5'
    equation_variables = 'T E'
    reactions = '
Cl- + Cl- -> CuCl2- : {Porosity * kF * exp(F / (R * T) * (E - EA))}
CuCl2- -> Cl- + Cl- : {kB}
HS- -> Cu2S         : {Porosity * kS * exp((1.0 + aS) * F / (R * T) * E) * exp (-F / (R * T) * (ES12 + aS3 * ES3))}
'

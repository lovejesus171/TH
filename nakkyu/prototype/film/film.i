...
# Diffusion terms
  [./DgradHSF]
    block = 'Film'
    type = CoefDiffusion
    coef = 2.91073E-8 #9.70244e-8 #[m2/hr] and porosity 0.03 and tortuosity 0.1
    variable = HS-
  [../]
  [./DgradHSS]
  ...
  [./DgradCl-F]
    block = 'Film'
    type = CoefDiffusion
    coef = 2.19456E-8 # Tortuosity = 0.1 Porosity 0.03 from the handbook original: 2.032E-5 cm2/s
    variable = Cl-
  [../]
  [./DgradCl-]
    block = 'Solution Copper'
  ...
  [./DgradCuCl2-_F]
    block = 'Film'
    type = CoefDiffusion
    coef = 1.40076E-8 #[m2/hr], tor & porosity = 0.1 & 0.03
    variable = CuCl2-
  [../]

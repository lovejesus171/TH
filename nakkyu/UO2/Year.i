...
[Functions]
  [H2O2_produce]
    type = ParsedFunction
    value = '1.02E-4 * 1E1 * (0.99883 - 11833.90869 * x)^(-1/-0.13308) * 31536000' #1.02E-4 mol/m3/Gy * 1E1 Gy/s * 31536000 s/yr
  []
[]
...
# Diffusion terms
  ...
  [./DgradOHm]
    block = 'Alpha Solution'
    type = CoefDiffusion
    coef = 1.52E-1 #[m2/s], at 25C
    variable = OH-
  [../]
  [./DgradH2O2]
    block = 'Alpha Solution'
    type = CoefDiffusion
    coef = 5.99E-2 #[m2/s], to be added
    variable = H2O2
  [../]
  [./DgradO2]
    block = 'Alpha Solution'
    type = CoefDiffusion
    coef = 7.88E-2 #[m2/s], to be added
    variable = O2
  [../]
  ...
  [./DgradUO22+]
    block = 'Alpha Solution'
    type = CoefDiffusion
    coef = 2.39E-2 #[m2/s], to be added
    variable = UO22+
  [../]
  [./DgradUO2CO322-]
    block = 'Alpha Solution'
    type = CoefDiffusion
    coef = 2.1E-2 #[m2/s], to be added
    variable = UO2CO322-
  [../]
  [./DgradUOH4]
    block = 'Alpha Solution'
    type = CoefDiffusion
    coef = 1.89E-2 #[m2/s], to be added
    variable = UOH4
  [../]
  [./DgradCO32-]
    block = 'Alpha Solution'
    type = CoefDiffusion
    coef = 2.56E-2 #[m2/s], to be added
    variable = CO32-
  [../]
  [./DgradFe2+]
    block = 'Alpha Solution'
    type = CoefDiffusion
    coef = 2.27E-2 #[m2/s], to be added
    variable = Fe2+
  [../]
  [./DgradH2]
    block = 'Alpha Solution'
    type = CoefDiffusion
    coef = 1.89E-1 #[m2/s], to be added
    variable = H2
  [../]
  [./DgradUO2CO334-]
    block = 'Alpha Solution'
    type = CoefDiffusion
    coef = 2.1E-2 #[m2/s], assumed same as UO2CO322-
    variable = UO2CO334-
  [../]
...
[BCs]
  ...
  [./BC_H2_Consumption_D]
    ...
    m = 1
    fraction = 0.99 #NMP = 0.01. Assumed portion of NMP is 1%
  [../]
  [./BC_H2_Consumption_H]
    type = H2
    variable = H2

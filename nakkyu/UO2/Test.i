...
[ChemicalReactions]
  [./Network]
    block = 'Alpha Solution'
    species = 'UO22+ UO32H2O H'
    track_rates = False

    equation_constants = 'Ea R T_Re'
    equation_values = '6E4 8.314 298.15'
    equation_variables = 'T'
    reactions = 'UO22+ -> UO32H2O + H + H : {1E-3*exp(-Ea/(R * T)*(1/T_Re - 1/T))}
                 UO22+ -> UO2O2:4H2O + H+ + H+ : {1E-3*exp(-Ea/(R*T)*(1/T_Re-1/T))}
                 UO2CO322- -> UO32H2O + CO32- + CO32- + H+ + H+ : {1E-4*exp(-Ea/(R*T)*(1/T_Re-1/T))}
                 UO2CO322- -> UO2O24H2O + CO32- + CO32- + H+ + H+ : {1E-4*exp(-Ea/(R*T)*(1/T_Re-1/T))}

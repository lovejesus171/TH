...
# Q reactions
  [./UO22+_Q]
    block = 'PotentialZone'
    type = ReactionQProduct
    variable = UO22+
    pp = UO32H2O_Cumulation
    Reaction_rate = kQ
    Num = 1
    Activation_energy = DelH
    T = T
...
#    EK_value = 0.4752
    ...
    kD_value = 9.11331E-17 #m/s, assumption from H2 size in kinetic diameter 289 pm -> Area: 6.56E-20 m2/atom
...
[Postprocessors]
  [./UO32H2O_Reaction]
    ...
    variable = UO22+
    v = UO2CO322-
    Saturation1 = 1E-2 #mol/m3
    Saturation2 = 1E-1 #mol/m3
    k1 = 3.15E4 #1/yr # M reaction
    k2 = 3.15E3 #1/yr # O reaction
    k3 = 2.71E1 #1/yr # Q reaction
    k4 = 2.71E2 #1/yr # S reaction 
  [../]
  [./UO32H2O_Cumulation]
    type = CumulativeValuePostprocessor
    postprocessor = UO32H2O_Reaction
  [../]
  [./UO2O24H2O_Reaction]
    type = PT
    variable = UO22+
    ...
    Saturation1 = 1E-2 #mol/m3
    Saturation2 = 1E-1 #mol/m3
    k1 = 3.15E4 #1/yr # N reaction
    k2 = 3.15E3 #1/yr # P reaction
    k3 = 2.71E1 #1/yr # R reaction
    k4 = 2.71E2 #1/yr # T reaction
  [../]
  [./UO2O24H2O_Cumulation]
    type = CumulativeValuePostprocessor
    postprocessor = UO2O24H2O_Reaction
  [../]
  [./Fe2O3_Reaction]
    type = Fe2O3
    variable = H2O2
    ...
    x = UO22+
    y = UO2CO322-
    k1 = 2.18E6 #1/yr # U reaction
    k2 = 1.86E7 #1/yr # V reaction
    k3 = 3.15E5 #1/yr # W reaction
    k4 = 3.15E4 #1/yr # X reaction
  [../]
  [./Fe2O3_Cumulation]
    type = CumulativeValuePostprocessor
    postprocessor = Fe2O3_Reaction
  [../]
  [./UO2precip_Reaction]
    type = UO2precip
    variable = H2O2
    ...
    k4 = 3.15E4 #1/yr # X reaction
  [../]
  [./UO2precip_Cumulation]
    type = CumulativeValuePostprocessor
    postprocessor = UO2precip_Reaction
  [../]
[]

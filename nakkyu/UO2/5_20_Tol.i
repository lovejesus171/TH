...
[Functions]
  [H2O2_produce]
    type = ParsedFunction
    value = '1.02E-4 * 1E3 * (0.99883 - 11833.90869 * x)^(-1/-0.13308)' #1.02E-4 mol/m3/Gy * 1E3 Gy/s
  []
#  [H2O2_produce]
#    type = ParsedFunction
#    value = '1E-5' #1 mol/m3/s
#  []
[]
...
# E,F,G,I,J,K -> For fuel surface and noble metal particles surface
  ...
  [./BC_O2_Production_E]
    ...
    Temperature = T
    Alpha1 = 0.41
    Standard_potential1 = 0.4 # Eqauilibrium potentials... -> Have to check the standard potential later!
    m = 1
    fraction = 0.99 #NMP = 0.01. Assumed portion of NMP is 1%
  [../]
  [./BC_O2_Production_I]
  ...
  [./BC_OH-_Production_F]
    ...
    Temperature = T
    Alpha1 = -0.41
    Standard_potential1 = 0.979 # Eqauilibrium potentials... -> Have to check the standard potential later!
    m = 1
    fraction = 0.99 #NMP = 0.01. Assumed portion of NMP is 1%
  [../]
  [./BC_OH-_Production_J]
  ...
  [./BC_OH-_Production_G]
    ...
    Temperature = T
    Alpha1 = -0.5
    Standard_potential1 = 0.444 # Eqauilibrium potentials... -> Have to check the standard potential later!
    m = 1
    fraction = 0.99 #NMP = 0.01. Assumed portion of NMP is 1%
  [../]
  [./BC_OH-_Production_K]
...
#  nl_abs_tol = 1e-6
  nl_rel_tol = 0.5 #default = 1e-7
#  nl_div_tol = 1E20 #default 1e10
#  l_rel_tol = 1e-35
  l_max_its = 30
  nl_max_its = 10
  dtmax = 100

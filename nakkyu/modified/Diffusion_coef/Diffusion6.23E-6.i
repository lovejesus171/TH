...
# Diffusion terms
  [./DgradHSF]
    block = 'Film'
    type = CoefDiffusion
    coef = 6.2316e-8 #[m2/hr], assumption: 1/100 to bulk (tortuosity 0.1, porosity: 0.1)
    variable = HS-
  [../]
  [./DgradHSS]
    block = 'Solution Copper'
    type = CoefDiffusion
    coef = 6.2316E-6 #[m2/hr], from the Smith experimental data, I used KouteckyLevich to extract diffusion coefficient.
    variable = HS-
  [../]

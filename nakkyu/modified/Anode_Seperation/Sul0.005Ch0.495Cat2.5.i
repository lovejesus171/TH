...
[Materials]
  [./CorrosionPotentialCal]
    ...
    kF = 0
    Porosity = 0.5
    SulfideAnodeAreaValue = 0.005
    ChlorideAnodeAreaValue = 0.495
    Area = 2.5
    nS = 1
  [../]
[]
...
#    Temperature = T
    ...
    Num = -1
    Area = SulfideAnodeArea  #Anodic Surface Area
 [../]
 [./BC_Cu2S]
    type = ADCu2S
    variable = Cu2S

...
[Functions]
  ...
  [./Decay_fn]
    ...
    value = '1.955 * 14548 * yts * ((t+40)^-0.76204) / (2 * pi * r * 4.83 + 2 * pi * r * r)'
...
# Gyeongju Bentonite type KJ II
  [./Bentonite_thermal_conductivity]
    ...
    args = 'H2O'
    function = '(0.0584 * H2O + 0.4738) * 365 * 24 * 3600' #[Wyr/mk]
    block = 'bentonite'
  [../]
  ...
  [./Bentonite_specific_heat]
    ...
    args = 'H2O'
    function = '(32.3 + 4.18 * H2O) / (100 + H2O) * 1000' #[J/kgK]
    block = 'bentonite'
  [../]
  ...
  [./Bentonite_density]
    ...
    prop_names = density
    prop_values = 2100 #[kg/m^3]
    block = 'bentonite'
  [../]
  [./hostrock_heatcond]
    type = HeatConductionMaterial
    specific_heat  = 1576
    thermal_conductivity  = 7.96E7
    block = 'hostrock'
  [../]
  [./hostrock_density]
    type = GenericConstantMaterial
...
# intrinsic permeability = hydraulic conductivity * dynamic viscosity /(density of water * gravity accelerator)
    permeability = '4E-21 0 0    0 4E-21 0    0 0 4E-21'   # hydraulic conductivity = 1E-13 [m/s]
  [../]
  [./backfill_permeability]
    type = PorousFlowPermeabilityConst
    block = 'backfill'
    permeability = '4E-21 0 0    0 4E-21 0    0 0 4E-21'
  [../]

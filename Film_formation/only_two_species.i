...
[Functions]
  [./IC_linear]
    type = ParsedFunction
    value = erf(100*(x-0.01)/0.001)
#    value = 1*(x-0.01)/0.001
  [../]
  [./IC_erf_Cu]
    type = ParsedFunction
    value = 8.96e6*erf(100*(x-0.01)/0.001)
  [../]
[]
...
# dCi/dt
  ...
  [../]
  [./DgradCu+]
    block = 'Film_domain Solution_domain'
    type = CoefDiffusion
    coef = 5e-9
    variable = CuHS-
  [../]
  ...
  [./Migration_HS-]
    block = 'Copper domain Film_domain Solution_domain'
    type = NernstPlanck
    T = 298.15
    Chemical_Species = HS-
    Potential = phi

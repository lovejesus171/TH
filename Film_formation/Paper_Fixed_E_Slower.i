...
# Isolated region not include in the calculation
  [./H+]
   block = 'Film'
   order = FIRST
  ...
  [./H2O]
   block = 'Film'
   order = FIRST
   initial_condition = 0 #[mol/m3] at 25 C
  [../]
  [./HS-]
    block = 'Film'
    order = FIRST
...
#   boundary = 'Copper_top'
 ...
 [./Isolated]
   ...
   boundary = Isolated
   value = 0
   variable = 'H+ OH- H2O HS- H2O2 SO42- O2 T Cl- CuCl2- Cu2S'
 [../]
[]

 ...
 */
class InterfaceEcorr : public InterfaceMaterial
{
public:
  static InputParameters validParams();

  InterfaceEcorr(const InputParameters & parameters);
...
private:
  ...
  MaterialProperty<Real> & _SulfideAnodeArea;
  Real _ChlorideAnodeAreaValue;
  MaterialProperty<Real> & _ChlorideAnodeArea;

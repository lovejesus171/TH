...
class CO32m_UO2CO334m;

template <>
InputParameters validParams<CO32m_UO2CO334m>();
 ...
 */
class CO32m_UO2CO334m : public IntegratedBC
{
public:
  static InputParameters validParams();

  CO32m_UO2CO334m(const InputParameters & parameters);

...
class CO32m_UO2CO334m_rem;

template <>
InputParameters validParams<CO32m_UO2CO334m_rem>();
 ...
 */
class CO32m_UO2CO334m_rem : public IntegratedBC
{
public:
  static InputParameters validParams();

  CO32m_UO2CO334m_rem(const InputParameters & parameters);

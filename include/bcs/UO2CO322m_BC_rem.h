...
class UO2CO322m_BC_rem;

template <>
InputParameters validParams<UO2CO322m_BC_rem>();
 ...
 */
class UO2CO322m_BC_rem : public IntegratedBC
{
public:
  static InputParameters validParams();

  UO2CO322m_BC_rem(const InputParameters & parameters);

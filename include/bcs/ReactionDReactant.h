...
class ReactionDReactant;

template <>
InputParameters validParams<ReactionDReactant>();
 ...
 */
class ReactionDReactant : public IntegratedBC
{
public:
  static InputParameters validParams();

  ReactionDReactant(const InputParameters & parameters);

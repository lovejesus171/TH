...
class UO2CO334m_BC_rem;

template <>
InputParameters validParams<UO2CO334m_BC_rem>();
 ...
 */
class UO2CO334m_BC_rem : public IntegratedBC
{
public:
  static InputParameters validParams();

  UO2CO334m_BC_rem(const InputParameters & parameters);

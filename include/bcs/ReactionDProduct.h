...
class ReactionDProduct;

template <>
InputParameters validParams<ReactionDProduct>();
 ...
 */
class ReactionDProduct : public IntegratedBC
{
public:
  static InputParameters validParams();

  ReactionDProduct(const InputParameters & parameters);

...
class ReactionCReactant;

template <>
InputParameters validParams<ReactionCReactant>();
 ...
 */
class ReactionCReactant : public IntegratedBC
{
public:
  static InputParameters validParams();

  ReactionCReactant(const InputParameters & parameters);

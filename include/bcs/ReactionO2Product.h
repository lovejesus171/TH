...
class ReactionO2Product;

template <>
InputParameters validParams<ReactionO2Product>();
 ...
 */
class ReactionO2Product : public IntegratedBC
{
public:
  static InputParameters validParams();

  ReactionO2Product(const InputParameters & parameters);

...
class ReactionCProduct;

template <>
InputParameters validParams<ReactionCProduct>();
 ...
 */
class ReactionCProduct : public IntegratedBC
{
public:
  static InputParameters validParams();

  ReactionCProduct(const InputParameters & parameters);

...
class ReactionBReactant;

template <>
InputParameters validParams<ReactionBReactant>();
 ...
 */
class ReactionBReactant : public IntegratedBC
{
public:
  static InputParameters validParams();

  ReactionBReactant(const InputParameters & parameters);
